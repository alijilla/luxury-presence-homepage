    ...
    >
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mb-20 text-center">
          ...
          <h2 className="mb-8 font-serif text-5xl font-medium tracking-tight text-white md:text-6xl">
            Search Listings
          </h2>
        ...
        <div className="mt-32 border-t border-white/5 pt-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <div className="lg:col-span-4 flex flex-col justify-center">
              ...
              <h3 className="font-serif text-4xl lg:text-5xl text-white mb-2 tracking-tight leading-[1.1]">
