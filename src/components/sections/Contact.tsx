      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-[#080808] p-10 md:p-14 rounded-none border border-white/5 flex flex-col justify-between">
          <div>
            ...
            <h2 className="font-serif text-5xl md:text-6xl text-white font-medium tracking-tight leading-tight mb-6">
              Let&apos;s talk <br/>
          ...
          <div className="divide-y divide-white/10 border-t border-white/10">
            <div className="py-5">
              ...
              <p className="font-serif text-xl text-white tracking-wide">206-919-6886</p>
            </div>
            <div className="py-5">
              <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-1.5">Office</p>
              <p className="font-serif text-xl text-white tracking-wide">The Ridge Realty Group</p>
            </div>
            <div className="py-5">
              <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-1.5">Address</p>
              <p className="font-serif text-xl text-white tracking-wide">3190 HW-160, Suite F<br/>Pahrump, Nevada 89048</p>
            </div>
            <div className="pt-5 pb-2">
              <p className="text-[10px] uppercase tracking-[0.2em] text-white/40 mb-1.5">Hours</p>
              <p className="font-serif text-xl text-white tracking-wide">Daily &middot; 8:00 AM–7:00 PM</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-[#080808] rounded-none border border-white/5 flex flex-col overflow-hidden">
          ...
          <div className="p-8 flex flex-col sm:flex-row sm:items-end justify-between gap-6 border-t border-white/5 bg-[#080808] z-10">
            <div>
              ...
              <p className="font-serif text-3xl text-white tracking-wide">Pahrump, Nevada</p>
            </div>
